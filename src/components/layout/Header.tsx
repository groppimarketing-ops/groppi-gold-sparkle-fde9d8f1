...
// Inline SVG social icons — zero extra JS bundle
...
const socialIconsData = [
  { icon: XIcon,         href: socialUrls.twitter,   label: 'X (Twitter)', event: 'twitter_click'   as const, color: '#1DA1F2', hoverGlow: 'hover:drop-shadow-[0_0_6px_rgba(29,161,242,0.5)]'  },
  { icon: FacebookIcon,  href: socialUrls.facebook,  label: 'Facebook',    event: 'facebook_click'  as const, color: '#1877F2', hoverGlow: 'hover:drop-shadow-[0_0_6px_rgba(24,119,242,0.5)]'  },
  { icon: InstagramIcon, href: socialUrls.instagram, label: 'Instagram',   event: 'instagram_click' as const, color: '#E4405F', hoverGlow: 'hover:drop-shadow-[0_0_6px_rgba(228,64,95,0.5)]'   },
  { icon: LinkedInIcon,  href: socialUrls.linkedin,  label: 'LinkedIn',    event: 'linkedin_click'  as const, color: '#0A66C2', hoverGlow: 'hover:drop-shadow-[0_0_6px_rgba(10,102,194,0.5)]'  },
  { icon: YouTubeIcon,   href: socialUrls.youtube,   label: 'YouTube',     event: 'youtube_click'   as const, color: '#FF0000', hoverGlow: 'hover:drop-shadow-[0_0_6px_rgba(255,0,0,0.5)]'     },
  { icon: TikTokIcon,    href: socialUrls.tiktok,    label: 'TikTok',      event: 'tiktok_click'    as const, color: '#69C9D0', hoverGlow: 'hover:drop-shadow-[0_0_6px_rgba(105,201,208,0.5)]' },
  { icon: PinterestIcon, href: socialUrls.pinterest, label: 'Pinterest',   event: 'pinterest_click' as const, color: '#E60023', hoverGlow: 'hover:drop-shadow-[0_0_6px_rgba(230,0,35,0.5)]'   },
];

const mobileIconsData       = socialIconsData.filter(s => ['Instagram', 'Facebook', 'TikTok', 'LinkedIn'].includes(s.label));
const mobileHiddenIconsData = socialIconsData.filter(s => !['Instagram', 'Facebook', 'TikTok', 'LinkedIn'].includes(s.label));
...
const Header = () => {
  ...
  return (
    <TooltipProvider delayDuration={300}>
      {/* CSS translate instead of framer-motion — same visual, zero JS runtime cost */}
      <header
      ...
      >
        <nav className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            {/* Logo — CSS hover scale, no framer-motion */}
                  ...
                  <Tooltip key={social.label}>
                    <TooltipTrigger asChild>
                      <a
                        ...
                        className={`social-icon-glow flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded ${social.hoverGlow}`}
              ...
              >
                {mobileIconsData.map((social) => (
                  <a
                    ...
                    aria-label={`Open ${social.label}`}
                    onClick={() => trackEvent({ event: social.event, location: 'header' })}
                    className={`social-icon-glow flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:scale-110 rounded ${social.hoverGlow}`}
                    style={{ color: social.color }}
                  >
