...
const caseStudies = [
  {
    id: 1, industryKey: 'restaurant', icon: UtensilsCrossed,
    challengeKey: 'case1.challenge', solutionKey: 'case1.solution', metricKey: 'case1.metric',
    link: '/portfolio/restaurant-branding',
  },
  {
    id: 2, industryKey: 'ecommerce', icon: ShoppingCart,
    challengeKey: 'case2.challenge', solutionKey: 'case2.solution', metricKey: 'case2.metric',
    link: '/portfolio/e-commerce-groei',
  },
  {
    id: 3, industryKey: 'construction', icon: Building2,
    challengeKey: 'case3.challenge', solutionKey: 'case3.solution', metricKey: 'case3.metric',
  ...
  return (
    <section className="section-spacing relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Case Studies Grid — CSS stagger */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {caseStudies.map((study, index) => {
            const Icon = study.icon;
            return (
              <div key={study.id} className={`animate-fade-up-${index + 1}`}>
                <LangLink
                  to={study.link}
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-foreground text-sm">{t(`home.caseStudies.${study.challengeKey}`)}</p>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-foreground text-sm">{t(`home.caseStudies.${study.solutionKey}`)}</p>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-4 rounded-lg bg-primary/10 border border-primary/30 group-hover:border-primary/60 group-hover:shadow-[0_0_25px_hsl(var(--gold)/0.2)] transition-all">
                    ...
                    <p className="text-primary font-bold text-lg">{t(`home.caseStudies.${study.metricKey}`)}</p>
                  </div>
        ...
        {/* CTA — CSS fade */}
        <div className="animate-fade-up-4 flex justify-center mt-12">
          <Button
            asChild size="lg"
