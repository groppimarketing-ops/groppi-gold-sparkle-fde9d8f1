...
import {
  Building2, UtensilsCrossed, Store, Home, ShoppingBag, Sparkles,
  Building, Rocket, Star, Quote, Truck, Briefcase, Hotel, Globe,
  ...
  return (
    <section className="section-spacing relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Eyebrow */}
        <span className="animate-fade-up block text-center text-primary text-xs font-semibold tracking-[0.2em] uppercase mb-4">
        ...
        {/* Benefits Row */}
        <div className="animate-fade-up-2 flex flex-wrap justify-center gap-4 md:gap-6 mt-8 mb-12">
        ...
        {/* Marquee Label */}
        <p className="animate-fade-up-3 text-center text-sm text-primary font-medium mb-6 tracking-wide">
          {t('home.clientLogoMarquee.marqueeLabel')}
        </p>

        {/* Logo Marquee — pure CSS, no framer-motion */}
        <div className="marquee-wrap relative overflow-hidden group" dir="ltr">
          {/* Fade edges */}
        ...
        {/* Micro Testimonials — CSS stagger */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={testimonial.key}
              className={`animate-fade-up-${index + 3} glass-card p-6 hover:border-primary/50 hover:shadow-[0_0_25px_hsl(var(--gold)/0.15)] hover:-translate-y-1 transition-all duration-500`}
            >
        ...
        {/* CTA Section — CSS fade */}
        <div className="animate-fade-up-6 mt-16 text-center">
