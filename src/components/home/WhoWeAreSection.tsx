...
const WhoWeAreSection = memo(() => {
  ...
  const handleCta = useCallback(() => navigate('/services'), [navigate]);
      ...
      >
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            {/* Right: Video Thumbnail — CSS fade-up */}
            <div className="animate-fade-up-2">
              ...
              >
                ...
                {/* Play button — pure CSS pulse (no framer-motion JS) */}
                <div className="absolute inset-0 flex items-center justify-center z-10">
                  <div
                    className="who-play-btn w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center border-2 border-primary/60 bg-background/20 backdrop-blur-sm"
